...
def get_savedir(savedir=None):
    ...
    print("word2word utils savedir: ", savedir)
...
def get_download_url(lang1, lang2):
    ...
    for line in open(filepath, 'r'):
        ...
        if lang1 == l1 and lang2 == l2:
            return f"http://mk.kakaocdn.net/dn/kakaobrain/word2word/{lang1}-{lang2}.pkl"
...
def download_or_load(lang1, lang2, custom_savedir):
    ...
    print("word2word utils fpath: ", fpath)
    if not os.path.exists(fpath):
        # download from cloud
        url = get_download_url(lang1, lang2)
        print("word2word utils url: ", url)
        if url is None:
        ...
        print("word2word utils Downloading data ...")
